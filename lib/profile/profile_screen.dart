...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Widget _buildMosaicStat(ThemeManager theme, String label, String value,
      IconData icon, Color color,
      {required double flex, VoidCallback? onTap}) {
    return Expanded(
        flex: (flex * 10).toInt(),
                          ...
                          IntrinsicHeight(
                              child: Row(children: [
                                _buildMosaicStat(
                                    theme,
                                    "STR",
                                    (xpController.attributes['STR']?.toStringAsFixed(0) ?? "0"),
                                    Icons.fitness_center_rounded,
                                    const Color(0xFFFF6B6B),
                                    flex: 1,
                                    onTap: () => _showTacticalToast(
                                        "> STRENGTH: Power & Resilience", theme)),
                                const SizedBox(width: 12),
                                _buildMosaicStat(
                                    theme,
                                    "AGI",
                                    (xpController.attributes['AGI']?.toStringAsFixed(0) ?? "0"),
                                    Icons.speed_rounded,
                                    const Color(0xFF4ECDC4),
                                    flex: 1,
                                    onTap: () => _showTacticalToast(
                                        "> AGILITY: Speed & Reflexes", theme))
                              ])),
                          const SizedBox(height: 12),
                          IntrinsicHeight(
                              child: Row(children: [
                                _buildMosaicStat(
                                    theme,
                                    "INT",
                                    (xpController.attributes['INT']?.toStringAsFixed(0) ?? "0"),
                                    Icons.psychology_rounded,
                                    const Color(0xFF95E1D3),
                                    flex: 1,
                                    onTap: () => _showTacticalToast(
                                        "> INTELLIGENCE: Knowledge & Strategy", theme)),
                                const SizedBox(width: 12),
                                _buildMosaicStat(
                                    theme,
                                    "VIT",
                                    (xpController.attributes['VIT']?.toStringAsFixed(0) ?? "0"),
                                    Icons.favorite_rounded,
                                    const Color(0xFFFFD700),
                                    flex: 1,
                                    onTap: () => _showTacticalToast(
                                        "> VITALITY: Health & Endurance", theme))
                              ])),
                          const SizedBox(height: 12),
                          IntrinsicHeight(
                              child: Row(children: [
                                _buildMosaicStat(
                                    theme,
                                    "SEN",
                                    (xpController.attributes['SEN']?.toStringAsFixed(0) ?? "0"),
                                    Icons.lightbulb_rounded,
                                    const Color(0xFF6C63FF),
                                    flex: 1,
                                    onTap: () => _showTacticalToast(
                                        "> FOCUS: Concentration & Awareness", theme)),
                                const SizedBox(width: 12),
                                _buildMosaicStat(
                                    theme,
                                    "LEVEL",
                                    xpController.level.toString(),
                                    Icons.trending_up_rounded,
                                    Colors.orangeAccent,
                                    flex: 1,
                                    onTap: () => _showTacticalToast(
                                        "> LVL ${xpController.level} REACHED", theme))
                              ])),
                          const SizedBox(height: 32),
